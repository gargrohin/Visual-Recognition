...
#             #c.TRAIN_DIR = '/Users/apple/Downloads/Adversarial_Video_Generation/Train'
#             print(c.TRAIN_DIR)
#         if opt in ('-c', '--clips_dir'):
#             c.TRAIN_DIR_CLIPS = c.get_dir(arg)
#             #c.TRAIN_DIR_CLIPS = '/Users/Downloads/Adversarial_Video_Generation/Clips'
